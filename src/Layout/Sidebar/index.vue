<template>
  <div>
    <el-menu
      ...
      :router="true"
    >
      <div class="grid grid-cols-5 gap-1 py-5">
        <div
          v-if="!isCollapse"
        ...
        >
          <el-icon v-if="!isCollapse" @click="handleChangeCollapse"
            ><Fold
          /></el-icon>
        </div>
        <div
          class="... col-span-5 flex cursor-pointer items-center justify-center"
        >
          <el-icon v-if="isCollapse" @click="handleChangeCollapse"
            ><Expand
          /></el-icon>
